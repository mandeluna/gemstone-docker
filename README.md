...
* The version should be only listed in one spot in the Dockerfile. Check [GemStone's website](https://gemtalksystems.com/products/gs64/) for the correct version to use. If the version does not exist the script will fail with an HTTP error (403 probably).
